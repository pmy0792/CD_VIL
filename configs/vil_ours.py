...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--eval_only_last',action='store_true')
    # Model parameters
    ...
    subparsers.add_argument('--shuffle', action='store_true', default=False, help='shuffle the data order')
    subparsers.add_argument('--label_shuffle', action='store_true', default=False, help='shuffle the label order when split the single dataset')
    ...
    subparsers.add_argument('--only_eval_last', action='store_true', help='Perform evaluation only when the end of the training last task')
    ...
    subparsers.add_argument('--train_mask', action='store_true', default=True, help='if using the class mask at training')
    subparsers.add_argument('--no_train_mask', action='store_false', dest='train_mask', help='if domain incremental setting, not using the class mask at training')
    subparsers.add_argument('--task_inc', default=False, type=bool, help='if doing task incremental')
    subparsers.add_argument('--domain_inc', action='store_true', default=False, help='if doing domain incremental')
    subparsers.add_argument('--versatile_inc', action='store_true', default=False, help='if doing versatile incremental')
    ...
    #! D-prompt config
    subparsers.add_argument('--d_prompt',action='store_true') 
    subparsers.add_argument('--d_prompt_as_dualprompt',action='store_true') 
    subparsers.add_argument('--total_session',default=5, type=int)
    subparsers.add_argument('--alpha', default=1.0, type=float) # coeff for logit distance loss
    subparsers.add_argument('--correct_d', action='store_true')
    subparsers.add_argument('--d_loss',default="std",type=str)
    subparsers.add_argument('--de_loss',default="cos_sim",type=str)
    subparsers.add_argument('--two_stage',default="d_then_e",type=str)